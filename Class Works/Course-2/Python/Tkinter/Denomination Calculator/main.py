...
upload = Image.open(r"Class Works\Course-2\Tkinter\Denomination Calculator\app_img.jpg")
upload.resize((300,300))
image = ImageTk.PhotoImage(upload)
label = Label(root, image=image, bg="lightblue")
label.place(x=100, y=20)

label1 = Label(root, text="Hey User! Welcome to Denominator Counter Application.", bg="lightblue")
